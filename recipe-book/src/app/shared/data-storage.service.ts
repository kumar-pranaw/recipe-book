...
export class DataStorageService {
  ...
  storeRecipes() {
    ...
    const req = new HttpRequest('PUT', 'https://my-recipe-book-f7422.firebaseio.com/recipes.json', this.recipeService.getRecipes(), {reportProgress: true});
    return this.httpClient.request(req);
  }

  getRecipes() {
    // this.httpClient.get<Recipe[]>('https://ng-recipe-book-3adbb.firebaseio.com/recipes.json?auth=' + token)
    this.httpClient.get<Recipe[]>('https://my-recipe-book-f7422.firebaseio.com/recipes.json', {
      observe: 'body',
      responseType: 'json'
    })
      .map(
